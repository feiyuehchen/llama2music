...
def compute_piece_chord_progression_irregularity(chord_seq, ngram=3):
  '''
...
def compute_structure_indicator(mat_file, low_bound_sec=0, upp_bound_sec=60, sample_rate=1):
  '''
