...
def main(**kwargs):
    ...
    os.system(f"cp llama_recipes/configs/training.py {train_config.output_dir}")
    ...
    tokenizer = LlamaTokenizer.from_pretrained(train_config.tokenizer_dir)
    ...
    if train_config.use_pretrained_peft_model:
        print("use peft")
