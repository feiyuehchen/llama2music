...
from llama_recipes.datasets.music_dataset import InstructionDataset as get_music_dataset
from llama_recipes.datasets.pretrained_music_dataset import InstructionDataset as get_pretrained_music_dataset
